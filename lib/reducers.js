...
import {
  ...
  rheinischesWoerterbuch, saechsischesWoerterbuch,
  levelSettings, EASY_LEVEL }
from './constants'

import { SET_LEVEL, SET_DISPLAY_TIME, SET_ELEMENT_COUNT,
  SELECT_ELEMENT, UNSELECT_ELEMENT }
from './actions'

const startSettingState = {
    ...EASY_LEVEL.settings,
    selectedElements: [ rheinischesWoerterbuch.key, saechsischesWoerterbuch.key ],
    objects: [ rheinischesWoerterbuch.data, saechsischesWoerterbuch.data ]
}
