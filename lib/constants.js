...
export const lampenTouche = {
  key: 'lampen',
  source: {
    label: 'kult Westmünsterland - Lampensammlung Touché (Museum)',
    url: 'https://codingdavinci.de/daten/#kult-westmunsterland'
  },
  data: 'lampen.json'
}

export const selectableElements = [
  rheinischesWoerterbuch, saechsischesWoerterbuch, lwlSoundArchiv, lampenTouche
];
